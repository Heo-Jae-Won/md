...
## <span style="color:#802548">_things to consider when organizing index_</span>
- sort order
    - cardinality
...
- this is good example of utilzing index
- index range scan is utilized
...
## <span style="color:#802548">_index access and filter condition_</span>
